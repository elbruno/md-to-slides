...
2. **Merge the decision inbox** from `.squad/decisions/inbox/` into `.squad/decisions.md`
3. **Deduplicate and consolidate decisions** when multiple entries cover the same topic
...
**I don't handle:** Domain work, implementation, reviews, or architecture choices.
